...
/**
 * Clears the cached verification. Used by Storybook/testing and a future
 * "verify again" affordance.
 */
export function clearIDVCache(): void {
  try {
    localStorage.removeItem(IDV_STORAGE_KEY);
  } catch {
    // localStorage unavailable — non-fatal
  }
}

...
const MOBILE_AGE_LABELS = ['15+', '51', '58', '65+'];
...
function LifecycleStrategy() {
  ...
  return (
    <Box sx={{ width: '100%', textAlign: 'center' }}>
      ...
      <Box sx={{ width: '100%', maxWidth: 'none', alignSelf: 'stretch', mb: 5, pt: { xs: 4, md: 3 }, px: { xs: 1.5, md: 0 } }}>
        <Slider
          value={sliderValue}
          onChange={(_, value) => {
        ...
        >
          {MOBILE_AGE_LABELS.map((label) => (
            <Typography key={label} variant="body" component="span" sx={{ color: 'text.primary', lineHeight: 1.25 }}>
              {label}
            </Typography>
          ))}
        </Box>

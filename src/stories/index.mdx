...
Full inventory of every component in Foundation — 8 stable, 7 in review, 24 draft. Sort by name or status.
...
export const COMPONENTS = [
  ...
  { name: 'Header',            status: 'draft',  story: '/?path=/story/public-web-header--default' },

      ...
      <Box sx={{ mb: 3, display: 'flex', alignItems: 'center', gap: 1 }}>
        <Box
          ...
          sx={(t: Theme) => ({
            ...
            px: 1.25, py: 0.5,
            border: '1px dashed', borderColor: previewEmpty ? 'primary.main' : 'border.default',
        ...
        >
          ...
          />
          <Typography variant="caption" sx={{ color: previewEmpty ? 'primary.main' : 'text.muted', fontWeight: 500 }}>
        ...
        <>
          ...
          {selectedAccount ? (
            ...
            <Stack spacing={4}>
              ...
              >
                <Box sx={{
                  px: 2.5, py: 2, borderBottom: '1px solid', borderBottomColor: 'border.subtle',
                  display: 'flex',

...
export const COMPONENTS: ComponentStatusEntry[] = [
  ...
  { name: 'BankAccountField',  status: 'draft',  story: '/?path=/story/form-components-bank-accounts-bankaccountfield--default' },
  ...
  { name: 'CardGrid',          status: 'draft',  story: '/?path=/story/components-card--grid' },
  { name: 'Checkbox',          status: 'stable', story: '/?path=/story/form-components-checkbox--default' },
  { name: 'CheckboxButtonGroup', status: 'draft', story: '/?path=/story/form-components-checkbox-checkboxbuttongroup--default' },
  { name: 'CheckboxCardGroup', status: 'draft',  story: '/?path=/story/form-components-checkbox-checkboxcardgroup--default' },
  { name: 'Chip',              status: 'review', story: '/?path=/story/components-chip--default' },
  { name: 'CloseButton',       status: 'draft',  story: '/?path=/story/atomic-components-closebutton--default' },
  ...
  { name: 'DescriptionList',   status: 'draft',  story: '/?path=/story/components-description-list-descriptionlist--default' },
  ...
  { name: 'ExpandableCardList', status: 'draft', story: '/?path=/story/components-expandable-expandablecardlist--default' },
  ...
  { name: 'FileCard',          status: 'draft',  story: '/?path=/story/form-components-fileupload-filecard--default' },
  ...
  { name: 'StepTransition',    status: 'draft',  story: '/?path=/story/form-components-stepped-forms-step-transition--default' },
  ...
  { name: 'ManagedList',       status: 'draft',  story: '/?path=/story/components-managed-list-managedlist--default' },
  ...
  { name: 'PageTransition',    status: 'draft',  story: '/?path=/story/utilities-page-transition--default' },
  ...
  { name: 'PosterPanel',       status: 'draft',  story: '/?path=/story/components-poster-panel--default' },
  ...
  { name: 'RadioButtonGroup',  status: 'draft',  story: '/?path=/story/form-components-radiogroup-radiobuttongroup--default' },
  { name: 'RadioCardGroup',    status: 'draft',  story: '/?path=/story/form-components-radiogroup-radiocardgroup--default' },
